...
trait Notify
{
    ...
    public function mail($user, $templateKey = null, $params = [], $subject = null, $requestMessage = null)
    {
        ...
        try {
            ...
            if (empty($user->email_key) || in_array($templateKey, $user->email_key) == false) {
                return false;
            }
            ...
            $email_from = $templateObj->email_from ?? $basic->sender_email;
    ...
    public function sms($user, $templateKey, $params = [], $requestMessage = null)
    {
        ...
        if (empty($user->sms_key) || in_array($templateKey, $user->sms_key) == false) {
            return false;
        }
    ...
    public function userPushNotification($user, $templateKey, $params = [], $action = [])
    {
        try {
            ...
            if (empty($user->in_app_key) || in_array($templateKey, $user->in_app_key) == false) {
                return false;
            }
