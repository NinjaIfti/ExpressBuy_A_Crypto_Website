...
@section('page_title',trans('Referral'))
@section('content')
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <div class="commission d-flex align-items-center justify-content-start">
                                            ...
                                            <div class="ms-4"><h5>@lang('Total Commission')</h5>
                                ...
                                <div class=" share_link d-flex align-items-center">
                                    ...
                                    <input type="text" class="input border-0" id="referralURL"
                                           value="{{route('register',['ref' => auth()->id()])}}" readonly>
