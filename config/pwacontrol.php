<?php return array (
  ...
  'icons' => 
  array (
    '72x72' => 'pwa/icon-72x72.png',
    '96x96' => 'pwa/icon-96x96.png',
    '128x128' => 'pwa/icon-128x128.png',
    '144x144' => 'pwa/icon-144x144.png',
    '152x152' => 'pwa/icon-152x152.png',
    '192x192' => 'pwa/icon-192x192.png',
    '384x384' => 'pwa/icon-384x384.png',
    '512x512' => 'pwa/icon-512x512.png',
  ),
  'splash' => 
  array (
